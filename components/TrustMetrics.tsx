...
export default function TrustMetrics() {
  ...
  return (
    <section className="relative z-20 -mt-8 max-w-7xl mx-auto px-5 sm:px-8">
      <div className="bg-brand-beige-card rounded-2xl p-6 sm:p-8 shadow-2xl border border-brand-beige text-brand-charcoal">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 divide-y sm:divide-y-0 sm:divide-x divide-brand-beige-dark/20">
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-baseline gap-1.5">
                    <span className="font-serif text-2xl sm:text-3xl font-bold text-brand-black tracking-tight">
                      {item.number}
                    </span>
                    <span className="text-xs font-sans tracking-wider uppercase text-brand-beige-dark font-semibold">
                      {item.unit}
                    </span>
                  </div>
                  <div className="w-8 h-8 rounded-lg bg-brand-black/5 flex items-center justify-center text-brand-charcoal">
                    <Icon className="w-4 h-4" />
                  </div>
                </div>

                <div>
                  <h3 className="text-xs font-semibold uppercase tracking-wider text-brand-black mb-1">
                    {item.label}
                  </h3>
